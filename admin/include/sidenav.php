    ...
    >
      ...
      >
        <ul class="flex flex-col pl-0 mb-0">
          ...
          <li class="mt-0.5 w-full">
            <a
              class="<?= ($current_page == 'table.php') ? 'bg-blue-500/13' : ''?> dark:text-white dark:opacity-80 py-2.7 text-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap px-4 transition-colors"
              href="table.php"
            >
              <div
                class="mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-center stroke-0 text-center xl:p-2.5"
          ...
          <li class="mt-0.5 w-full">
            <a
              class="<?= ($current_page == 'billing.php') ? 'bg-blue-500/13' : ''?> dark:text-white dark:opacity-80 py-2.7 text-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap px-4 transition-colors"
              href="billing.php"
            >
              <div
          ...
          <li class="mt-0.5 w-full">
            <a
              class="<?= ($current_page == 'virtual-reality.php') ? 'bg-blue-500/13' : ''?> dark:text-white dark:opacity-80 py-2.7 text-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap px-4 transition-colors"
              href="virtual-reality.php"
            >
              <div
                class="mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-center stroke-0 text-center xl:p-2.5"
              >
          ...
          <li class="mt-0.5 w-full">
            <a
              class="<?= ($current_page == 'profile.php') ? 'bg-blue-500/13' : ''?> dark:text-white dark:opacity-80 py-2.7 text-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap px-4 transition-colors"
              href="profile.php"
            >
              <div
                class="mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-center stroke-0 text-center xl:p-2.5"
